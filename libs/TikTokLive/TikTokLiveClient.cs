...
namespace TikTokLive
{
    public class TikTokLiveClient
    {
        ...
        /// <summary>
        /// Use a pre-fetched ttwid cookie (e.g. copied from browser DevTools).
        /// Skips the automatic homepage fetch.
        /// </summary>
        public TikTokLiveClient Ttwid(string ttwid)
        {
            Auth.TtwidAuth.OverrideTtwid = ttwid;
            return this;
        }
        ...
        public async Task RunAsync(CancellationToken ct = default)
        {
            ...
            // Connected is emitted after the WebSocket handshake succeeds (see SocketLoop).
